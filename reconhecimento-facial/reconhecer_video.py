...
ap.add_argument("--detector", required=False,
	...
	help="Caminho para o detector de faces do OpenCV")
ap.add_argument("--embedding-model", required=False,
	default="openface_nn4.small2.v1.t7",
	help="Caminho para a rede treinada para extrair features das faces")
ap.add_argument("--recognizer", required=False,
	default="output/recognizer.pickle",
	help="Caminho para o modelo de reconhecimento de faces")
ap.add_argument("--le", required=False,
	default="output/le.pickle",
	help="Caminho para as labels codificadas")
ap.add_argument("--confidence", type=float,
	default=0.5,
	help="Probabilidade mínima para evitar falsos positivos")
